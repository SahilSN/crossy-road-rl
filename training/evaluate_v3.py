...
MODELS = [
    ("PPO", "200k", PPO, "results/ppo_v3_checkpoints/ppo_basic_v3_200000_steps"),
    ("PPO", "400k", PPO, "results/ppo_v3_checkpoints/ppo_basic_v3_400000_steps"),
    ("PPO", "600k", PPO, "results/ppo_v3_checkpoints/ppo_basic_v3_600000_steps"),
    ("PPO", "800k", PPO, "results/ppo_v3_checkpoints/ppo_basic_v3_800000_steps"),
    ("PPO", "1m",   PPO, "results/ppo_basic_v3_1m"),

    ("DQN", "200k", DQN, "results/dqn_v3_checkpoints/dqn_basic_v3_200000_steps"),
    ("DQN", "400k", DQN, "results/dqn_v3_checkpoints/dqn_basic_v3_400000_steps"),
    ("DQN", "600k", DQN, "results/dqn_v3_checkpoints/dqn_basic_v3_600000_steps"),
    ("DQN", "800k", DQN, "results/dqn_v3_checkpoints/dqn_basic_v3_800000_steps"),
    ("DQN", "1m",   DQN, "results/dqn_basic_v3_1m"),
]
